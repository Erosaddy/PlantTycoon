            ...
            <div class="container">
                <div class="container_inner">
                    ...
                    <div class="write_form">
                        <form id="noticeForm" action="${ctx}/notice/modify" method="post">
                        	<sec:csrfInput/>
...
<!-- 				                <input type="text" id="noticeTitle" name="noticeTitle" placeholder="제목을 입력하세요" class="form-control" required> -->
				            	<input type="text" id="noticeTitle" name="noticeTitle" value="${notice.noticeTitle}" class="form-control" required>
				            </div>
				
				            <div class="write_box">
				                <p>내용</p>
<%-- 				                <textarea id="editor" name="noticeContent"></textarea> name 속성 추가 --%>
				            	<textarea id="editor" name="noticeContent">${notice.noticeContent}</textarea>
				            </div>
